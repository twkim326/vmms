...
<table cellpadding="0" cellspacing="0" cellspacing="0" class="tableType01">
	...
	<%
		...
		<tr>
		 	<td class="center" colspan="3" style="background-color:#e9e9e9;" nowrap>총계</td>
	...
	<%	}
		...
		<tr>
			<td class="center number" nowrap></td>
		 	<td class="center" colspan="2" style="background-color:#e9e9e9;" nowrap>소계(<%=groupValues[1]%>)</td>
		...
		<tr>
		 	<td class="center" colspan="3" style="background-color:#e9e9e9;" nowrap>합계(<%=groupValues[0]%>)</td>
		 	<% for (int j = 0; j < summaryColumns.length; j++) { %>
...
<script type="text/javascript">
	...
	<% } else { %>
		_submit($("form"), "SalesReportVMExcel.jsp", "_top");
	<% } %>
	}
</script>