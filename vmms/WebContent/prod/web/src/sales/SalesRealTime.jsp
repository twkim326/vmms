...
<iframe id="detail" name="detail" src="SalesRealTimeDetail.jsp" scrolling="no" frameBorder="0" class="mt23" style="width:100%; height:207px; min-height:510px; border-style:none;"></iframe>
