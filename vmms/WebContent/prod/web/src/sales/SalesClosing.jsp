...
<form name="search" id="search" method="post" action="SalesClosingDetail.jsp" target="detail">
...
<div style="position:relative;">
	...
	<a style="position:absolute; right:0; top:5px; font-size:11px; color:#888;">* 오늘 마감 현황은 상세 매출 현황과 다를 수 있습니다.</a>

</div>



<iframe id="detail" name="detail" src="SalesClosingDetail.jsp" scrolling="no" frameBorder="0" class="mt23" style="width:100%; height:207px; border-style:none;"></iframe>
