...
// 엑셀 생성
	...
	try {
		...
		sheet.addCell(new Label(col, row, objSales.data.get("ORGAN") + " 코드", format1));
		sheet.mergeCells(col, row, col, row + 1);
		...
		Formula formula = new Formula(col++, row, "SUM(G6:G" + row + ")", format4);
