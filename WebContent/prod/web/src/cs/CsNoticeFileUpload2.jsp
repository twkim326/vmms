...
<%
	...
	String uploadPath = request.getRealPath("/download"); // upload는 폴더명 / 폴더의 경로를 구해옴
	...
	try {
		...
		*/
		...
		fileName1 = multi.getFilesystemName("cate"); // name=file1의 업로드된 시스템 파일명을 구함(중복된 파일이 있으면, 중복 처리 후 파일 이름)
		orgfileName1 = multi.getOriginalFileName("cate"); // name=file1의 업로드된 원본파일 이름을 구함(중복 처리 전 이름)
/* 
